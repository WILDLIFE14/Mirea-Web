...
<?php include 'includes/top-header.php';?>
    <div class="container">
        <button type="button"><a href="../my-cart.php">EN</a></button>
    </div>
                ...
                ?>
					...
					<td class="cart-product-quantity">
						<div class="quant-input">
				             ...
				             <input type="number" id="product<?php echo $_SESSION['sid'] ?>" value="<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>" name="quantity[<?php echo $row['id']; ?>]">
					...
					<td class="cart-product-grand-total"><span id="total_price<?php echo $_SESSION['sid'] ?>" class="cart-grand-total-price"><?php echo ($_SESSION['cart'][$row['id']]['quantity'] * $row['productPrice'] + $row['shippingCharge']); ?></span>.00 Rub</td>
				</tr>
<script>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Сумма<span id="total_price_main" class="inner-left-md"><?php echo $_SESSION['tp'] = "$totalprice"; ?></span>.00 Rub
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
